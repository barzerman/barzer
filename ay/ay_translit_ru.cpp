		...
		while (s < end)
		{
			...
			case 'a':
			{
                if( s[1] == 't' && s[2] == 'i' && s[3] =='o' && s[4] =='n' ) {
					...
					russian.append( c_prev == 'i'&& !s[1] && beg+3<s ? "я" : "а");
				} else { 
                    switch (c1) {
                    case 'e':
                    case 'y':
			...
			case 'i':
			{
                if( s[1] =='d' && s[2] == 'e' && s[3] =='n' && (s[4] =='c' || s[4] =='t') ) {
                    russian.append("и");
                } else if( s[1] =='e' && !s[2]  ) {
                    russian.append((++s,"и"));
                } else
                if( s[1] && s[2] =='e' && !isVowel(s[1]) ) {
                    russian.append("ай");
                } else {
				    switch (c1)
				    {
			...
			case 'j':
			{
                if( src_1 == end ) {
                    ...
                    case 'u': russian.append("ю"); s+=1; break;
